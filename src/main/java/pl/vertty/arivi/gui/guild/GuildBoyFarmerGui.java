...
public class GuildBoyFarmerGui
{
    public static void openTopki(final Player player) {
        ...
        category.addElement(31, new ItemData(Item.END_CRYSTAL, 0, 1, "&r&9Rozpocznij tworzenie &fBoyFarmera", new String[]{"", "&r&8>> &cBoyFarmer tworzy sie na &4Y:70","&r&8>> &aKliknij, aby rozpoczac!"}), new ItemClick() {
            @Override
            public void onClick(Player p0, Item p1) {
